...
module arith_right_shifter (
    ...
    genvar idx_0_1829886280;
    
    generate
        for (idx_0_1829886280 = 0; idx_0_1829886280 < 5; idx_0_1829886280 = idx_0_1829886280 + 1) begin: forLoop_idx_0_1829886280
            mux_2 mux (
                .s0(M_mux_s0[idx_0_1829886280]),
                .i0(M_mux_i0[idx_0_1829886280]),
                .i1(M_mux_i1[idx_0_1829886280]),
                .out(M_mux_out[idx_0_1829886280])
            );
        end
    endgenerate
