...
module right_shifter (
    ...
    genvar idx_0_2067368072;
    
    generate
        for (idx_0_2067368072 = 0; idx_0_2067368072 < 5; idx_0_2067368072 = idx_0_2067368072 + 1) begin: forLoop_idx_0_2067368072
            mux_2 mux (
                .s0(M_mux_s0[idx_0_2067368072]),
                .i0(M_mux_i0[idx_0_2067368072]),
                .i1(M_mux_i1[idx_0_2067368072]),
                .out(M_mux_out[idx_0_2067368072])
            );
        end
    endgenerate
