...
module left_shifter (
    ...
    genvar idx_0_276753944;
    
    generate
        for (idx_0_276753944 = 0; idx_0_276753944 < 5; idx_0_276753944 = idx_0_276753944 + 1) begin: forLoop_idx_0_276753944
            mux_2 mux (
                .s0(M_mux_s0[idx_0_276753944]),
                .i0(M_mux_i0[idx_0_276753944]),
                .i1(M_mux_i1[idx_0_276753944]),
                .out(M_mux_out[idx_0_276753944])
            );
        end
    endgenerate
